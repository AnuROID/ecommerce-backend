...
import com.example.ecommerce.model.Sizes;
...
public class CreateProductRequest {
    ...
    // Corrected field name from 'size' → 'sizes'
    private Set<Sizes> sizes = new HashSet<>();

    private String imageUrl;

    // Corrected spelling: Level instead of Lavel
    ...
    public int getDiscountPresent() { return discountPresent; }
    public void setDiscountPresent(int discountPresent) { this.discountPresent = discountPresent; }
    ...
    public Set<Sizes> getSizes() { return sizes; }
    public void setSizes(Set<Sizes> sizes) { this.sizes = sizes; }
